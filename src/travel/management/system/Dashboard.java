...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton checkpackages,bookpackage, viewpackage,viewhotels,destinations;
    ...
    Dashboard(String username){
        ...
        checkpackages.setMargin(new Insets(0, 0, 0, 175));
        ...
        viewpackage.setMargin(new Insets(0, 0, 0, 195));
        ...
        viewhotels.setMargin(new Insets(0, 0, 0, 210));
        ...
        bookhotel.setMargin(new Insets(0, 0, 0, 220));
        ...
        viewBookedHotel.setMargin(new Insets(0, 0, 0, 150));
        ...
        destinations.setMargin(new Insets(0, 0, 0, 210));
        ...
        payments.setMargin(new Insets(0, 0, 0, 230));
        ...
        calculators.setMargin(new Insets(0, 0, 0, 230));
        ...
        notepad.setMargin(new Insets(0, 0, 0, 245));
        ...
        about.setMargin(new Insets(0, 0, 0, 255));
        ...
        text.setFont(new Font("Raleway", Font.PLAIN,57));
        image.add(text);
